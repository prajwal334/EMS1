    ...
    return (
        <div className='p-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mt-4'>
                ...
                <SummaryCard icon={<FaMoneyBillWave />} text="Total Salary" number="$654" color="bg-red-600"/>
            </div>
            ...
            <div className='mt-12'>
                ...
                <SummaryCard icon={<FaTimesCircle />} text="Leave Rejected" number={4} color="bg-red-600"/>
            </div>
            </div>
        </div>

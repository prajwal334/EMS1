...
Employee N-Dash        </h3>
      ...
      <nav className="flex-1 overflow-y-auto px-4 py-6 space-y-1">
        {[
          ...
          { to: "/admin-dashboard/leaves", icon: <FaCalendarCheck />, label: "Leaves" },
          { to: "/admin-dashboard/salary/add", icon: <FaMoneyBillWave />, label: "Salary" },
          { to: "/admin-dashboard/attendance", icon: <FaClock />, label: "Attendance" },
          { to: "/admin-dashboard/holidays", icon: <FaCalendarCheck />, label: "Holidays" },
          { to: "/admin-dashboard/settings", icon: <FaCogs />, label: "Change Password" },
